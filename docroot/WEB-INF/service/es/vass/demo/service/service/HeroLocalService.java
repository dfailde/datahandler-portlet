...
/**
 * Provides the local service interface for Hero. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author diego.failde
 * @see HeroLocalServiceUtil
...
public interface HeroLocalService extends BaseLocalService, InvokableLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link HeroLocalServiceUtil} to access the hero local service. Add custom service methods to {@link es.vass.demo.service.service.impl.HeroLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
